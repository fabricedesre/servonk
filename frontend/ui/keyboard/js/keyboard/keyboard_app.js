...
(function (exports) {
  ...
  KeyboardApp.prototype.CONTAINER_ELEMENT_ID = 'keyboard';
  ...
  KeyboardApp.prototype._startComponents = function () {
    ...
    // Servonk: Force rendering.
    // console.log("Servonk call setLayoutPage 0");
    // this.setLayoutPage(0);
  ...
  KeyboardApp.prototype.getContainer = function () {
    ...
    return document.getElementById(this.CONTAINER_ELEMENT_ID);
  };
